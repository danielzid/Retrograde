...
from physics import calc_accel, update_bodies, handle_collisions, cleanup_bodies
import random
...
class Engine:
    ...
    def update(self, dt):
        ...
        update_bodies(self.bodies, ax, ay, dt)
        self.bodies = handle_collisions(self.bodies)
        self.bodies, _ = cleanup_bodies(self.bodies, None, 13000, 500)
    ...
    def draw(self):
        ...
        t1 = font.render(f"Mode: {self.spawn_mode}", True, (255,255,255))
        t2 = font.render(f"Spawn Vel: {int(self.spawn_vel)}", True, (255,255,255))
        t3 = font.render(f"Bodies: {len(self.bodies)}", True, (255,255,255))
